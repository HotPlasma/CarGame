...
Polymorphic function derived from collidable class which takes any collidable in this case a tyre and allows it to collide with any other collidable. 
...
\begin{DoxyParams}{Parameters}
{\em Given\+Texture} & A iterator of textures in a vector game time \\
\hline
\end{DoxyParams}
